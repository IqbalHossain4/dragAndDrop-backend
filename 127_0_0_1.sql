...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2023 at 10:41 AM
...
-- Database: `dragdrop`
--
CREATE DATABASE IF NOT EXISTS `dragdrop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dragdrop`;
...
('root', '[{\"db\":\"dragdrop\",\"table\":\"fonts\"},{\"db\":\"dragdrop\",\"table\":\"selectedfonts\"},{\"db\":\"dragdrop\",\"table\":\"groupname\"}]');
...
('root', '2023-10-03 08:39:06', '{\"Console\\/Mode\":\"collapse\"}');
